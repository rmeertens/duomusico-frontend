...
var lastLanguageRequested;
        ...
        function displayCurrentLanguage(languageDisplayed)
        {
            ...
            a.innerHTML = "<h3>Now showing songs with the language:</h3> \
            <h1><span class=\"label label-primary\" >\
        <span class=\"flag-icon flag-icon-"+flagServerAdapter(languageDisplayed)+"\"></span>"+languageDisplayed+"</span><h1>"
        }
